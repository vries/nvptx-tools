...
This program has absolutely no warranty.\n",
  ...
  if (verbose)
    {
      ...
      print_val (stderr, "Initial free device memory", free_mem);
      ...
      fatal_unless_success (r, "could not get default heap size");
      print_val (stderr, "Default heap size", default_heap_size);
    }
  ...
  report_val (stderr, "Set heap size", heap_size);
